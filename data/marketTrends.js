window.SMARTWS_MARKET_TRENDS = {
    ...
    seasonal: [
        ...
        { month: 'Mar-Apr', focus: 'Spring + Easter', action: 'ทำ Word Search / Crossword ธีมฤดูใบไม้ผลิ' },
        { month: 'May-Jun', focus: 'End of Year + Summer', action: 'ทำกิจกรรมเกม, bingo, review packets' },
        { month: 'Jul-Aug', focus: 'Back to School', action: 'ทำ classroom routines, tracing, matching' },
        { month: 'Sep-Oct', focus: 'Halloween + Fall', action: 'ทำ math puzzle และ worksheet แนว seasonal' },
        { month: 'Nov-Dec', focus: 'Thanksgiving + Winter', action: 'ทำ reading + gratitude + holiday workbook' }
    ]
};